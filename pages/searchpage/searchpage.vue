    ...
    <view class="nav">
      ...
      <view class="searchWrapper">
        ...
        <view class="deleteIcon" @click="deleteTerms">
          <image src="../../static/icos/delete2.png"></image>
        </view>
      </view>
