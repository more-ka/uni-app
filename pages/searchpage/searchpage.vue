<template>
	<view class="page">
		<view class="movie" v-for="movie in searchData" :key="movie.id">
...
<script>
  import uniNavBar from "@/components/uni-nav-bar/uni-nav-bar.vue"
    ...
    onLoad(e) {
      // let movieName = JSON.parse(e.movieName)
      // this.sendSearch(e.movieName)
...
.playLinkItem {
  ...
  font-size: 14px;
  /* border-image:linear-gradient(to right,#12cad6,#fa163f,#e4f9ff) 1 10; */
  /* border-image:linear-gradient(to right,#64ccda,#fb5b5a,#e4f9ff) 1 10; */
  border-image: linear-gradient(to right,#64ccda,#fb5b5a85,#e4f9ff) 1 10;
  
  border-radius: 12px;
  /* background: linear-gradient(135deg, rgba(35,183,203,1) 0%, rgba(35,183,203,1) 0%, rgba(217,217,217,0) 100%); */
  /* background: linear-gradient(135deg, rgba(35,183,203,1) 0%, rgba(35,183,203,1) 0%, rgba(217,217,217,1) 100%); */
} 
